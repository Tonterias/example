...
class NotificationResourceIT {
    ...
    private static final Message DEFAULT_MESSAGE = Message.MESSAGE1;
    private static final Message UPDATED_MESSAGE = Message.MESSAGE2;

    private static final Status DEFAULT_STATUS = Status.INMACULATE;
    private static final Status UPDATED_STATUS = Status.INCOURSE;
    ...
    public static Notification createEntity(EntityManager em) {
        Notification notification = new Notification().date(DEFAULT_DATE).message(DEFAULT_MESSAGE).status(DEFAULT_STATUS);
        // Add required entity
        Appuser appuser;
    ...
    public static Notification createUpdatedEntity(EntityManager em) {
        Notification notification = new Notification().date(UPDATED_DATE).message(UPDATED_MESSAGE).status(UPDATED_STATUS);
        // Add required entity
        Appuser appuser;
        if (TestUtil.findAll(em, Appuser.class).isEmpty()) {
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.date(UPDATED_DATE).message(UPDATED_MESSAGE).status(UPDATED_STATUS);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.status(UPDATED_STATUS);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.date(UPDATED_DATE).message(UPDATED_MESSAGE).status(UPDATED_STATUS);
