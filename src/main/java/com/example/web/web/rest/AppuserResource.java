...
import com.example.web.service.AppuserQueryService;
...
/**
 * REST controller for managing {@link com.example.web.domain.Appuser}.
 */
@RestController
@RequestMapping("/api")
public class AppuserResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/appusers/{id}", consumes = { "application/json", "application/merge-patch+json" })
